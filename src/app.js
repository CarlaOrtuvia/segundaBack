...
mongoose.connect(`mongodb+srv://carlitaortuvia:${process.env.passmongodb}@cluster0.rvdrpi8.mongodb.net/?retryWrites=true&w=majority`)
    .then(() => console.log('BDD conectada'))
    .catch(error => console.error('Error en conexion a BDD', error))
